    ...
    */
    ...
    handleSubmit = (e) => {
        ...
        if (post.id == null) {
            ...
            fetchData(url, reqSavePost, recSavePost, {method:'POST', body:newPost})
        } else { //existing post
    ...
    render() {
        const { categories, openEditPost, isOpen, reqSavePost, recSavePost, fetchData, post, editText, editType, match} = this.props
